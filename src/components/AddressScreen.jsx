    ...
    <section className="address-screen" aria-label="지역 검색">
      ...
      <header className="address-header">
        <button className="address-icon-button address-back" type="button" aria-label="뒤로가기" onClick={onBack}>
          <img className="address-back-head" src={`${import.meta.env.BASE_URL}assets/address-back-head.svg`} alt="" />
          <img className="address-back-line" src={`${import.meta.env.BASE_URL}assets/address-back-line.svg`} alt="" />
        </button>
      ...
      <main className="address-content">
        ...
        <form className="address-form" onSubmit={handleSubmit}>
          <label className="address-search-field">
            ...
            <img src={`${import.meta.env.BASE_URL}assets/address-search.svg`} alt="" />
          </label>
